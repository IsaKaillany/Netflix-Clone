...
.then(data => {
    data.genres.forEach(item => {
        fetchMoviesListByGenres(item.id, item.name) //Chama uma função que ainda não existe p/ pegar todos os filmes de tal gênero e passar como parâmetro o id e o nome
    });
})
